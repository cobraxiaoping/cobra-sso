...
/**
 * 默认授权页面是由WhitelabelApprovalEndpoint 实现，我们覆盖/oauth/confirm_access 
 * 完全拷贝WhitelabelApprovalEndpoint
 * 相同的请求地址/oauth/confirm_access @RestController相较 @FrameworkEndpoint先执行
 * 我们修改TEMPLATE 模版 完成自动提交。
 */
@RestController
